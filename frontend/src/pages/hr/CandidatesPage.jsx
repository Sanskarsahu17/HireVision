...
import JobSelector from "../../components/hrPage/candidatesAppliedComponents/JobSelector";
import CandidateList from "../../components/hrPage/candidatesAppliedComponents/candidateList";
      ...
      <div className="ml-64 p-8 w-full">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
            ...
            <p className="text-slate-400">Manage and track candidate applications</p>
          </motion.div>

          {/* Job Selector Dropdown */}
          <JobSelector jobOptions={Object.keys(groupedCandidates)} selectedJob={selectedJob} setSelectedJob={setSelectedJob} />

          {/* Display Candidates for Selected Job */}
          {selectedJob && <CandidateList candidates={groupedCandidates[selectedJob]} />}
        </div>
      </div>
    </div>
  );
